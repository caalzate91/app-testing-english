    ...
    return (
      <div className="p-4">
        <div className="animate-pulse">
          <div className="bg-gray-300 h-6 w-48 rounded mb-4" aria-label="Cargando título"></div>
          <div className="space-y-3">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-gray-300 h-24 rounded-lg" aria-label={`Cargando lección ${i}`}></div>
            ))}
          </div>
        </div>
      </div>
